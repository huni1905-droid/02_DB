...
--> DB에 영구 반영된 것 처럼 보이지만 실제로 아직 DB에 반영된 것 아님
-- 트렌잭션에 INSERT 3개 있음
...
-- ROLLBACK TO "SP1" 구문 수행

-- ROLLBACK TO "SP2"; 구문 수행 시 SP2, SP3 SAVEPOINT 삭제됨
...
-- SP2 지점까지 롤백
ROLLBACK TO "SP2";
SELECT *FROM DEPARTMENT2; -- 개발6팀만 삭제(SP2 지점 SAVEPOINT 전 개발5팀 있었으므로)
